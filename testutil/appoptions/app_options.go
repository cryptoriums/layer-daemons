...
// to `layerd`. The real concrete implementation for this interface is in the "viper" package which is used
...
func GetDefaultTestAppOptions(homePath string, customFlags map[string]interface{}) servertypes.AppOptions {
	...
	fao.Set(appconfig.GrpcAddress, config.DefaultGRPCAddress)
