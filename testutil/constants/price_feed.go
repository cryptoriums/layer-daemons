...
var (
	...
	// Exchange 0 prices
	Exchange0_Price4_TimeT = &servertypes.ExchangePrice{
	...
	// Exchange 1 prices
	Exchange1_Price1_TimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId1,
		Price:          Price1,
		LastUpdateTime: &TimeT,
	}
	Exchange1_Price2_AfterTimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId1,
		Price:          Price2,
		LastUpdateTime: &TimeTPlusThreshold,
	}
	Exchange1_Price3_BeforeTimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId1,
		Price:          Price3,
	...
	// Exchange 2 prices
	Exchange2_Price2_TimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId2,
		Price:          Price2,
		LastUpdateTime: &TimeT,
	}
	Exchange2_Price3_AfterTimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId2,
		Price:          Price3,
		LastUpdateTime: &TimeTPlusThreshold,
	}
	Exchange2_Price1_BeforeTimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId2,
		Price:          Price1,
		LastUpdateTime: &TimeTMinusThreshold,
	}
	...
	// Exchange 3 prices
	Exchange3_Price3_TimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId3,
		Price:          Price3,
		LastUpdateTime: &TimeT,
	}
	Exchange3_Price4_AfterTimeT = &servertypes.ExchangePrice{
		ExchangeId:     ExchangeId3,
		Price:          Price4,
		LastUpdateTime: &TimeTPlusThreshold,
	}
	...
	// Price Updates
	Market9_SingleExchange_AtTimeUpdate = []*servertypes.MarketPriceUpdate{
		{
			MarketId: MarketId9,
	...
	AtTimeTPriceUpdate = []*servertypes.MarketPriceUpdate{
		{
			MarketId: MarketId9,
			ExchangePrices: []*servertypes.ExchangePrice{
				Exchange1_Price1_TimeT,
	...
	AtTimeTSingleExchangePriceUpdate = []*servertypes.MarketPriceUpdate{
		{
			MarketId: MarketId0,
			ExchangePrices: []*servertypes.ExchangePrice{
	...
	MixedTimePriceUpdate = []*servertypes.MarketPriceUpdate{
		{
			MarketId: MarketId9,
			ExchangePrices: []*servertypes.ExchangePrice{
				Exchange1_Price1_TimeT,
